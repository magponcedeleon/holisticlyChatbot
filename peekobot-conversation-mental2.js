const chat = {
    ...
    10: {
        text: "I'm happy you think so! 😄<br>Let's move on!",
        next: 18
    },
    11: {
        text: "I'm happy about that 😄<br>Let's move on!",
        next: 18
    },
    12: {
    ...
    14: {
        text: "I like that you are curious!<br>I'm also very curious!",
        next: 15
    },
    15: {
        text: "For me, you are a <b>whole person with a unique set of characteristics –</b> internal and external – that are intrinsically connected.<br>Having said that, let's go to our free services!<br>",
        options: [
            {
                text: "Yes, please!",
                next: 18
    ...
    18: {
        text: "We have many <b>mental health topics for you.</b>.<br>Take your pick 👇",
        options: [
            {
